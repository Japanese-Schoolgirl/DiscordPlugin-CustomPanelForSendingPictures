...
# TODO:
- ".sent" файлы не генерируются автоматически, это связано с проблемой получения ссылки из ID отправленного файла (потому что Dispatch возвращает только ID канала, но не ID сообщения и уж тем более не имеет в себе свойства ссылки на файл);<br />
